...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cadence.setText(produitValuesPref.getString("cadence","Empty"));

        edit_qntite2=findViewById(R.id.edit_qntite2);
        edit_qntite2.setText(produitValuesPref.getString("qtefab","Empty"));
    ...
    public void onClickStart3(){
        if ((mBound3 & (Main4Activity.flagChrono3==true))|| Main2Activity.var==2) {
