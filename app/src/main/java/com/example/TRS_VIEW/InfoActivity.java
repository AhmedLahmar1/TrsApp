...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String  cadence=produitValuesPref.getString("cadence","Empty");
         String nombreDePieces=produitValuesPref.getString("qtefab","Empty");
    ...
    private void setupVChart() {
        ...
        switch (Main2Activity.var){
            ...
            case 2:
                ...
                VvisitsSeries = new XYSeries("PAUSE");
                break;
            default:
                VvisitsRenderer.setColor(Color.RED);
                VvisitsSeries = new XYSeries("PAUSE");
    ...
    private void setupHChart() {
        ...
        HmultiRenderer.setYAxisMax(90000);
                    ...
                    while (!isInterrupted()) {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Double ff=(Double.valueOf(netValue)*100/Double.valueOf(InfoActivity.nombreDePiecess))+100;
